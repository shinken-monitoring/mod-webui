...
from webui_mapping import object_class_map, dm_mapping

def itersorted(self, hints=None):
    preselected_ids = []
    preselection = False
    if hints is not None:
        logger.debug("[WebUI-API Regenerator] Hint is %s" % hints["target"])
    if hints is None:
        # return all items
        hints = {}
        ...
        try:
            ...
            logger.error("[WebUI-API Regenerator] Hint_services exception: %s" % exp)
            pass
...
# from them :)
class WebUIRegenerator(Regenerator):
    def __init__(self):
        Regenerator.__init__(self)
    ...
    def all_done_linking(self, inst_id):
        # Call base Regenerator method to create objects ...
        Regenerator.all_done_linking(self, inst_id)

        logger.warning(
            "[WebUI-API Regenerator], all_done_linking ..."
        )
        ...
        logger.warning(
            "[WebUI-API Regenerator], sortable and sorted objects ..."
        )
        ...
        logger.warning(
            "[WebUI-API Regenerator], contact connected objects ..."
        )
        ...
        logger.warning(
            "[WebUI-API Regenerator], name lookup objects ..."
        )


    def manage_update_host_status_brok(self, b):
        logger.warning(
            "[WebUI-API Regenerator], manage_update_host_status_brok ..."
        )

        # Call base Regenerator method to create objects ...
        Regenerator.manage_update_host_status_brok(self, b)
