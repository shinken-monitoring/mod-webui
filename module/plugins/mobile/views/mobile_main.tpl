...
%overall_itproblem = app.datamgr.get_nb_all_problems(app.check_user_authentication())
...
<div id="main" data-theme="a">
	...
	<ul data-role="listview" data-inset="true" data-theme="a">
		...
		%if overall_itproblem > 0:
			<li><a href="/mobile/problems">Problems<span class="ui-li-count ui-btn-up-c ui-btn-corner-all">{{app.datamgr.get_nb_all_problems(app.check_user_authentication())}}</span></a></li>
