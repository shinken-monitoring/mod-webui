...
%rebase("layout", title='Technical for hosts/services', css=['technical/css/technical.css'], js=['technical/js/jquery.floatThead.min.js'], breadcrumb=[ ['All hosts', '/technical'] ])
