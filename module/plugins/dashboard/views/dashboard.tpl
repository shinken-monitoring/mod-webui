      ...
      <tr>
         <td>
            <center><a href="/all?search=type:host isnot:UP" class="btn btn-sm">
               ...
               <span class="badger-title hosts"><i class="fas fa-plus" style="color: #ccc"></i>&nbsp;Hosts</span>
         ...
         <td>
            <center><a href="/all?search=type:service isnot:OK" class="btn btn-sm">
               ...
               <span class="badger-title services"><i class="fas fa-plus" style="color: #ccc"></i>&nbsp;Services</span>
         ...
         <td>
            <center><a href="/problems" class="btn btn-sm">
               ...
               <span class="badger-title itproblem"><i class="fas fa-plus" style="color: #ccc"></i>&nbsp;IT Problems</span>
         ...
         <td>
            <center><a href="/impacts" class="btn btn-sm">
               ...
               <span class="badger-title impacts"><i class="fas fa-plus" style="color: #ccc"></i>&nbsp;Impacts</span>
