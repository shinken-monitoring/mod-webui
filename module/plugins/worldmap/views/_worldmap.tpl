<script>
   ...
   //------------------------------------------------------------------------------
   mapInit = function() {
      if (debugMaps) console.log('mapInit ...');
      if (mapsApiLoading) {
         mapsApiLoaded=true;
      }
      if (! mapsApiLoaded) {
      ...
      $.getScript("/static/worldmap/js/oms.min.js", function( data, textStatus, jqxhr ) {
         if (debugMaps) console.log('Spiderify API loaded ...');
         $.getScript(debugMaps ? "/static/worldmap/js/markerclusterer.js" : "/static/worldmap/js/markerclusterer_packed.js", function( data, textStatus, jqxhr ) {
            if (debugMaps) console.log('Google marker clusterer API loaded ...');
            $.getScript(debugMaps ? "/static/worldmap/js/markerwithlabel.js" : "/static/worldmap/js/markerwithlabel_packed.js", function( data, textStatus, jqxhr ) {
               if (debugMaps) console.log('Google labeled marker API loaded ...');
               ...
               try {
                  ...
                  if (debugMaps) console.error('mapInit, exception : '+e.message);
               }
