...
def get_json(hostname):
    ...
    for record in records:
        ...
        content +='<img src="/static/timeline2/img/host_downtime.png" style="width:32px; height:32px;"><br/>'
        timeline.append({
                "start": t.isoformat(),
                "content" : content,
                # "group": 'Transitions'
    ...
    # for record in records:
        ...
        # if message[1] == "OK" and current_state != "":
            ...
            # content +='<img src="/static/timeline2/img/host_%s.png" style="width:32px; height:32px;"><br/>' % current_state.lower()
...
pages = {get_page: {'routes': ['/timeline2/:hostname'], 'view': 'timeline2', 'static': True},
         get_json: {'routes': ['/timeline2/json/:hostname'], 'view': 'timeline2', 'static': True},}
