...
%rebase("layout", js=['eltdetail/js/eltdetail.js', 'eltdetail/js/flot/jquery.flot.min.js', 'eltdetail/js/flot/jquery.flot.resize.min.js', 'eltdetail/js/flot/jquery.flot.pie.min.js', 'eltdetail/js/flot/jquery.flot.categories.min.js', 'eltdetail/js/flot/jquery.flot.time.min.js', 'eltdetail/js/flot/jquery.flot.stack.min.js', 'eltdetail/js/flot/jquery.flot.valuelabels.js',  'eltdetail/js/raphael.min.js', 'eltdetail/js/morris.min.js', 'eltdetail/js/jquery.color.js', 'eltdetail/js/bootstrap-switch.js', 'eltdetail/js/jquery.Jcrop.js', 'eltdetail/js/graphs.js', 'eltdetail/js/custom_views.js', 'eltdetail/js/canvas.js'], css=['eltdetail/css/bootstrap-switch.css', 'eltdetail/css/eltdetail.css', 'eltdetail/css/morris.css', 'eltdetail/css/jquery.Jcrop.css', 'eltdetail/css/canvas.css'], user=user, app=app, refresh=True, breadcrumb=breadcrumb, title=title)
