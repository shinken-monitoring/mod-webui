...
<div class="row" style="padding: 0px;">
  ...
  <div id="toolbar" class="col-lg-3 col-md-4 col-sm-4">
    ...
    <div class="panel panel-info" id="actions">
      ...
      <div class="panel-body">
        <ul class="list-group">
          <li class="list-group-item" title="Try to fix all selected problems (launch event handler if defined)"><a href="javascript:try_to_fix_all();"><i class="fa fa-ambulance"></i> Try to fix</a></li>
          ...
          <li class="list-group-item" title="Schedule a one day downtime for all selected problems"><a href="javascript:downtime_all('{{user.get_name()}}')"><i class="fa fa-check"></i> Schedule a downtime</a></li>
          <li class="list-group-item" title="Ignore checks for selected services (disable checks, notifications, event handlers and force Ok)"><a href="javascript:remove_all('{{user.get_name()}}')"><i class="fa fa-eraser"></i> Delete</a></li>
        </ul>
      </div>
    </div>
      ...
      %if pb.host_name != last_hname:
        ...
        <div class="panel panel-default" style="margin: 0">
          <div class="panel-heading">
            <div class='tick pull-left' style="cursor:pointer;" onmouseover="hovering_selection('{{helper.get_html_id(pb)}}')" onclick="add_remove_elements('{{helper.get_html_id(pb)}}')">
