...
%rebase("layout", title=title, js=['js/jquery.sparkline.min.js', 'js/shinken-charts.js', 'problems/js/problems.js'], css=['problems/css/problems.css', 'eltdetail/css/eltdetail.css'], navi=navi, page="/all", elts_per_page=elts_per_page)
