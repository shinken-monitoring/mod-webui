...
<script type="text/javascript">
   ...
   $( 'form' ).submit(function(event) {
      ...
      if ($('#ticket_downtime').prop("checked")) {
         ...
         do_schedule_downtime("{{name}}", downtime_start.format('X'), downtime_stop.format('X'), '{{user.get_name()}}', $('#ticket_title').val(), '{{app.shinken_downtime_fixed}}', '{{app.shinken_downtime_trigger}}', '{{app.shinken_downtime_duration}}');
