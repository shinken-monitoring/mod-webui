<table class="table table-condensed">
   <thead>
      ...
      %     {'id':'itemtype_name',           'active': False, 'title': 'Item type'},
      %     {'id':'items_name',              'active': False if not narrow else True, 'title': 'Computer'},
      %     {'id':'status',                  'active': False, 'title': 'Status'},
      %     {'id':'status_name',             'active': True if not narrow else False,  'title': 'Status'},
      ...
      %     {'id':'content',                 'active': True if not narrow else False,  'title': 'Content'},
      %     {'id':'due_date',                'active': True if not narrow else False,  'title': 'Due date', 'date': 'due'},
      %     {'id':'solvedate',               'active': True if not narrow else False,  'title': 'Solved date', 'date': 'end'},
      %     {'id':'closedate',               'active': True if not narrow else False, 'title': 'Closed date'},
      ...
      %     {'id':'ticketcategories_name',   'active': True if not narrow else False,  'title': 'Category'},
      %     {'id':'slas_name',               'active': False, 'title': 'SLA'},
      %     {'id':'requesttypes_name',       'active': True if not narrow else False,  'title': 'Source'},
   ...
   <tbody style="font-size:x-small;">
      ...
      %for ticket in tickets:
         ...
         <tr class="{{ticket_class}}" data-toggle="collapse" data-target="#arrays-{{idx}}">
            ...
            %elif 'id' in key['id']:
            <td><a href="{{ticket_page_uri['uri']}}{{ticket[key['id']]}}" target="_blank">{{ticket[key['id']]}}</a></td>
            %else:
         ...
         <tr class="collapse" id="arrays-{{idx}}">
            <td colspan="{{columns}}" class="hiddenRow">
               <div class="panel panel-{{ticket_class}}>
               <!--
                  // Tickets status:
